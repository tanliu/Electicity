        ...
        <div class="main">
            ...
            <input hidden="hidden"  name="subjectcontest.stuId" value="00001"/>
                <p class="short-input ue-clear">
                    <label>学号：</label>
                    	<input type="text" placeholder="请输入学生学号" name="subjectcontest.studentNo"/> 
                    <label>获奖者姓名：</label>
                        <input type="text" placeholder="请输入学生姓名" name="subjectcontest.stuName"/> 
                </p>
                <p class="short-input ue-clear">
                    <label>奖励名称：</label>
                        <input type="text" placeholder="请输入奖励名称" name="subjectcontest.rewardName"/> 
                    <label>获奖项目：</label>
                        <input type="text" placeholder="请输入获奖项目" name="subjectcontest.rewardProject"/> 
                </p>
                <div class="short-input select ue-clear" >
                    <label>奖励等级：</label>
                    <input  hidden="hidden" value="" name="subjectcontest.rewardGrade"/>
                    ...
                    <label>奖励级别：</label>
                    <input  hidden="hidden" value="" name="subjectcontest.rewardLevel"/>
                    <div class="select-wrap" >
                ...
                <p class="short-input ue-clear">
                    <label>授予单位：</label>
                       <input  type="text" placeholder="请输入授予单位" name="subjectcontest.grantUnits"/>
                    <label>指导老师：</label>
                ...
                <p class="short-input ue-clear">
                    <label>奖励时间：</label>   
                        <input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" name="subjectcontest.rewardDate"/>             
               		<label>附加信息：</label>
