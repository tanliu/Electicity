            ...
            <form id="myForm">
               ...
               <input hidden="hidden"  name="subjectcontest.stuId" value="${subjectcontest.stuId}"/>
                <p class="short-input ue-clear">
                    <label>学号：</label>
                    	<input type="text" readonly="readonly" name="subjectcontest.studentNo"  value="${subjectcontest.studentNo}" /> 
                    <label>获奖者姓名：</label>
                        <input type="text" readonly="readonly" name="subjectcontest.stuName" value="${subjectcontest.stuName}"/>  
                </p>
                <p class="short-input ue-clear">
                    <label>奖励名称：</label>
                        <input type="text" placeholder="请输入奖励名称" name="subjectcontest.rewardName" value="${subjectcontest.rewardName}"/> 
                    <label>获奖项目：</label>
                        <input type="text" placeholder="请输入获奖项目" name="subjectcontest.rewardProject" value="${subjectcontest.rewardProject}"/> 
                </p>
                <div class="short-input select ue-clear" >
                    <label>奖励等级：</label>
                    <input  hidden="hidden" value="<s:property value="subjectcontest.rewardGrade"/>" name="subjectcontest.rewardGrade"/>
                    ...
                    <label>奖励级别：</label>
                    <input  hidden="hidden" value="<s:property value="subjectcontest.rewardLevel"/>" name="subjectcontest.rewardLevel"/>
                    <div class="select-wrap" >
                ...
                <p class="short-input ue-clear">
                 <label>奖励时间：</label>   
                        <input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" name="subjectcontest.rewardDate" value="<s:date name="subjectcontest.rewardDate" format="yyyy-MM-dd"></s:date>"/>       
                    <label>附加信息：</label>
