...
<div class="main">
    <p class="short-input ue-clear">
        ...
        <label>姓名：</label>
        <input type="text" name="countryScholarship.stuName" placeholder="请输入姓名"  /> 
        <label>学号：</label>
        <input type="text" name="countryScholarship.studentNo" placeholder="请输入学号" /> 
    </p>
    
     <div class="short-input select ue-clear" >
        
        <label>政治面貌：</label>
        <input  hidden="hidden"  name="countryScholarship.politicalStatus">
        <div class="select-wrap">
         ...
         <label>性别：</label>
        <input  hidden="hidden"  name="countryScholarship.sex">
        <div class="select-wrap">
        	<div class=" select-title ue-clear" ><span >请选择</span><i class="icon"></i></div>
            <ul class="select-list" >
                <li id="">请选择</li>
  ...
  <div class="short-input select ue-clear" >
        ...
        <label>学院：</label>
        <input  hidden="hidden"  name="countryScholarship.orgName">
        <div class="select-wrap">
        	<div class=" select-title ue-clear" ><span >请选择</span><i class="icon"></i></div>
           <ul class="select-list" >
                <li id="">请选择</li>
         ...
         <label>年级：</label>
        <input  hidden="hidden"  name="countryScholarship.grade">
        <div class="select-wrap">
        	<div class=" select-title ue-clear" ><span >请选择</span><i class="icon"></i></div>
            <ul class="select-list" >
                <li id="">请选择</li>
...
<div class="short-input select ue-clear" >
  <label>专业：</label>
       <input  hidden="hidden" value="" name="countryScholarship.major">
        <div class="select-wrap">
				...
				<label>获奖名称：</label>
        <input  hidden="hidden"  value="" name="countryScholarship.rewardName" >
        <div class="select-wrap">
        	<div class=" select-title ue-clear" ><span>请选择</span><i class="icon"></i></div>
            <ul class="select-list" >
                <li id="">请选择</li>
      ...
      <div class="short-input select ue-clear" >
        <label>学年：</label>
        <input  hidden="hidden" value="" name="countryScholarship.academicYear">
      <div class="select-wrap">
		...
		<label>学期：</label>
    	 <input  hidden="hidden" value="" name="countryScholarship.term">
        <div class="select-wrap">
        	<div class=" select-title ue-clear" ><span >请选择</span><i class="icon"></i></div>
            <ul class="select-list" >
             <li id="">请选择</li>
