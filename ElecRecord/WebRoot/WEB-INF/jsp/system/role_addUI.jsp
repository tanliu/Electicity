 ...
 */
  ...
  <!-- button按钮的控制 -->
  <script type="text/javascript">
  function addrole(formID,type,url){   	
	var nullEL=isNull();
	//判断是否为空
	...
	<form id="myForm">
		...
		<TD  style="overflow:auto;border: 0;width:100%">
			<p class="short-input ue-clear">
				<label>角色名称：</label>
				<s:textfield value="" name="role.roleName" class="strutsinput noNull"></s:textfield>	
								<label>角色编号：</label>
				<s:textfield value="" name="role.roleNo" class="strutsinput noNull"></s:textfield>	
				<label>备注信息：</label>
				<s:textfield value="" name="role.memo" class="strutsinput"></s:textfield>	
			</p>
		 <div class="btn ue-clear" >
	     <a href="javascript:addrole('myForm','post','${basePath}system/role_add.action')"  class="confirm save">增加权限</a> 
		</div>
